...
if(trim($name) == '') {
	...
	echo '<div class="error_message">Please enter a valid tel number.</div>';
	exit();
} else if(!is_numeric($tel)) {
	echo '<div class="error_message">tel number can only contain digits.</div>';
	exit();
...
if(get_magic_quotes_gpc()) {
	$textarea1 = stripslashes($textarea1);
}
...
$e_content = "\"$textarea1\"" . PHP_EOL . PHP_EOL;
$e_reply = "You can contact $name by email, $email or by tel $tel";
